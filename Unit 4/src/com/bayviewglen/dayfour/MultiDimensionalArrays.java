...
public class MultiDimensionalArrays {
	...
	private static void exampleFive() {
		...
		for (int i=0; i < arr2D.length; i++){
			arr2D[i] = new int[] {1,2,6,9}; //:| // put new int[] so you can quickly declare and initialize an array by simply creating an object
			//arr2D[i] = {1,2,6,9}; // :( not allowed to do that because you need create a new array entirely
		}
